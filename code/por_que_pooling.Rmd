...
que están contagiados $p_{0i}$ que son diseminados aleatoriamente en la población.
...
```{r funcion_probabilidad_contagio, cache=TRUE, echo = FALSE}
...
```{r crear_poblacion_ejemplo, cache=TRUE}
...
### Función de probabilidad de contagio
